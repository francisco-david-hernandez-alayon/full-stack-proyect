...
public static class EnemyDtoMapper
{
    public static Enemy ToDomain(EnemyResponseDto dto)
    {
        ...
        return new Enemy(dto.Id, dto.Difficulty, new EnemyName(dto.Name), dto.HealthPoints, dto.DamageAttack, dto.SpeedAttack, CriticalDamageDtoMapper.ToDomain(dto.CriticalDamage), dto.MoneyReward);
    }
    ...
    public static Enemy ToDomainFromCreateRequest(EnemyCreateRequestDto dto)
    {
        return new Enemy(
            ...
            dto.DamageAttack,
            dto.SpeedAttack,
            CriticalDamageDtoMapper.ToDomain(dto.CriticalDamage),
            dto.MoneyReward
        );
    }
    ...
    public static EnemyResponseDto ToDto(Enemy enemy)
    {
        return new EnemyResponseDto
        {
            ...
            CriticalDamage = CriticalDamageDtoMapper.ToDto(enemy.GetCriticalDamage()),
